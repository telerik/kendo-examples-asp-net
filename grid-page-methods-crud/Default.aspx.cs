...
public partial class _Default : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static IEnumerable<ProductViewModel> Create(IEnumerable<ProductViewModel> products)
    {
    ...
    [WebMethod]
    public static void Update(IEnumerable<ProductViewModel> products)
    {
        using (var northwind = new Northwind())
        {
    ...
    [WebMethod]
    public static void Destroy(IEnumerable<ProductViewModel> products)
    {
        using (var northwind = new Northwind())
        {
